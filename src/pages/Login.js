...
export const Login = () => {
  ...
  async function handleGuestLoing(event) {
    event.preventDefault();
    email.current.value = "omid@example.com";
    password.current.value = "omid123";
    try {
      const authDetail = {
        email: email.current.value,
        password: password.current.value,
